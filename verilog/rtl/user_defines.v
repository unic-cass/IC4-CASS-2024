...
`define GPIO_MODE_INVALID                  13'h1808
...
`define USER_CONFIG_GPIO_5_INIT  `GPIO_MODE_INVALID			//Not used pins
`define USER_CONFIG_GPIO_6_INIT  `GPIO_MODE_INVALID
`define USER_CONFIG_GPIO_7_INIT  `GPIO_MODE_INVALID

`define USER_CONFIG_GPIO_8_INIT `GPIO_MODE_USER_STD_OUTPUT		//SLRV output

`define USER_CONFIG_GPIO_9_INIT  `GPIO_MODE_USER_STD_INPUT_NOPULL  	//Slopedetect Input pins
`define USER_CONFIG_GPIO_10_INIT `GPIO_MODE_USER_STD_INPUT_NOPULL
`define USER_CONFIG_GPIO_11_INIT `GPIO_MODE_INVALID			//Slopedetect Output pins	
...
`define USER_CONFIG_GPIO_15_INIT `GPIO_MODE_USER_STD_OUTPUT		// S3CHIP Output LED pins
...
`define USER_CONFIG_GPIO_23_INIT `GPIO_MODE_USER_STD_OUTPUT		//socreboard_segment control output pins
...
`define USER_CONFIG_GPIO_27_INIT `GPIO_MODE_USER_STD_OUTPUT		//socreboard_segment data output pins	
...
`define USER_CONFIG_GPIO_34_INIT `GPIO_MODE_USER_STD_INPUT_NOPULL	//socreboard_Push button input pins		
